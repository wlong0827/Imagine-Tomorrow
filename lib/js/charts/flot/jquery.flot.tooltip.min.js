...
Array.prototype.indexOf || (Array.prototype.indexOf = function (t, i) {
  if (void 0 === this || null === this) throw new TypeError('"this" is null or not defined');var e = this.length >>> 0;for (i = +i || 0, 1 / 0 === Math.abs(i) && (i = 0), 0 > i && (i += e, 0 > i && (i = 0)); e > i; i++) {
    if (this[i] === t) return i;
  }return -1;
}), function (t) {
  var i = { tooltip: !1, tooltipOpts: { content: "%s | X: %x | Y: %y", xDateFormat: null, yDateFormat: null, monthNames: null, dayNames: null, shifts: { x: 10, y: 20 }, defaultTheme: !0, onHover: function onHover() {} } },
      e = function e(t) {
    ...
    function e(t) {
      ...
      var s = o.getDomElement();if (e) {
        ...
        a = t.plot.plugins.length;if (this.plotPlugins = [], a) for (var n = 0; a > n; n++) {
    ...
    }if (i.series.yaxis.ticks !== void 0) for (var y in i.series.yaxis.ticks) {
