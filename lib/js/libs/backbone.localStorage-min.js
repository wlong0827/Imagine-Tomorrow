 ...
 */(function (a, b) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == "object" && a.require ? module.exports = b(require("underscore"), require("backbone")) : typeof define == "function" && define.amd ? define(["underscore", "backbone"], function (c, d) {
  ...
  function c() {
    ...
    if (!this.localStorage) throw "Backbone.localStorage: Environment does not support localStorage.";this.name = a;var b = this.localStorage().getItem(this.name);this.records = b && b.split(",") || [];
  }, a.extend(b.LocalStorage.prototype, { save: function save() {
      ...
      return localStorage;
    }), jsonData: function jsonData(a) {
      return a && JSON.parse(a);
    }, _clear: function _clear() {
      var b = this.localStorage(),
          c = new RegExp("^" + this.name + "-");b.removeItem(this.name), (a.chain || a)(b).keys().filter(function (a) {
        return c.test(a);
      }).each(function (a) {
        b.removeItem(a);
    ...
    var e = c.localStorage || c.collection.localStorage,
        f,
        g,
        h = b.$.Deferred && b.$.Deferred();try {
      switch (a) {case "read":
          f = c.id != undefined ? e.find(c) : e.findAll();break;case "create":
          f = e.create(c);break;case "update":
          f = e.update(c);break;case "delete":
          f = e.destroy(c);}
    } catch (i) {
